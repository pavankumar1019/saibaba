...
?>
    ...
    <footer>
        <div class="container-fluid">
            <div class="col-md-12">
            <p style="text-align: center"> Copyright &copy;<script>document.write(new Date().getFullYear())</script>&nbsp;<a href="" style="color:blue;">DM SHRI SHIRDI SAI BABA TEMPLE</a> All Rights Reserved</p>
            </div>
        </div>
    </footer>
