    ...
    <table class='table table-bordered'>
        ...
        <tr>
            <td colspan="2">
    			...
    			<span class="glyphicon glyphicon-edit"></span>  Modifie
				</button>
                <a href="index.php" class="btn btn-large btn-success" style="float: right;"><i class="glyphicon glyphicon-backward"></i> &nbsp; Back To Report</a>
            </td>
        </tr>
    </table>
</form>
