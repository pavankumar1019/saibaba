...
<!-- Password -->
<input type="text" id="defaultLoginFormPassword" class="form-control mb-4" placeholder="Designation">

<input type="number" id="defaultLoginFormPassword" class="form-control mb-4" placeholder="Phone number">
        <!-- Forgot password -->
